...
// true  -> Array#includes
  ...
  }, {"./_to-absolute-index": 71, "./_to-iobject": 73, "./_to-length": 74}],
...
// 6 -> Array#findIndex
    ...
    module.exports = function (TYPE, $create) {
      ...
      return function ($this, callbackfn, that) {
        ...
        var index = 0;
        var result = IS_MAP ? create($this, length) : IS_FILTER ? create($this,
            0) : undefined;
        var val, res;
        for (; length > index; index++) {
  ...
  7: [function (require, module, exports) {
    ...
    module.exports = function (original) {
      ...
      if (isArray(original)) {
        ...
        if (typeof C == 'function' && (C === Array || isArray(
            C.prototype))) {
          C = undefined;
        }
        if (isObject(C)) {
  ...
  }, {"./_is-array": 33, "./_is-object": 34, "./_wks": 80}],
...
// all enumerable object keys, includes symbols
  ...
  19: [function (require, module, exports) {
    ...
    var $export = function (type, name, source) {
      ...
      var target = IS_GLOBAL ? global : IS_STATIC ? global[name]
...
// 21.2.5.3 get RegExp.prototype.flags
  ...
  24: [function (require, module, exports) {
    module.exports = require('./_shared')('native-function-to-string',
        Function.toString);
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
    require('./_hide')(IteratorPrototype, require('./_wks')('iterator'),
        function () {
          return this;
        });
    ...
    module.exports = function (Base, NAME, Constructor, next, DEFAULT, IS_SET,
      ...
      if ($anyNative) {
        ...
        if (IteratorPrototype !== Object.prototype && IteratorPrototype.next) {
          ...
          if (!LIBRARY && typeof IteratorPrototype[ITERATOR]
              != 'function') {
      ...
      if (DEFAULT) {
        ...
        if (FORCED) {
          ...
          $export($export.P + $export.F * (BUGGY || VALUES_BUG), NAME,
              methods);
        }
      }
      return methods;
  ...
  43: [function (require, module, exports) {
    ...
    var fastKey = function (it, create) {
      ...
      if (!isObject(it)) {
        return typeof it == 'symbol' ? it : (typeof it
        == 'string' ? 'S' : 'P') + it;
      }
      if (!has(it, META)) {
...
// Create object with fake `null` prototype: use iframe Object with cleared prototype
  ...
  47: [function (require, module, exports) {
    ...
    exports.f = require('./_descriptors') ? gOPD
...
// fallback for IE11 buggy Object.getOwnPropertyNames with iframe and window
  ...
  }, {"./_object-gopn": 49, "./_to-iobject": 73}],
...
// 19.1.2.9 / 15.2.3.2 Object.getPrototypeOf(O)
  ...
  }, {"./_has": 26, "./_shared-key": 64, "./_to-object": 75}],
...
// Works with __proto__ only. Old v8 can't work with null proto objects.
          ...
          function (test, buggy, set) {
            try {
              set = require('./_ctx')(Function.call,
                  require('./_object-gopd').f(Object.prototype,
                      '__proto__').set, 2);
              set(test, []);
  ...
  }, {"./_descriptors": 15, "./_global": 25, "./_object-dp": 45, "./_wks": 80}],
...
// 7.3.20 SpeciesConstructor(O, defaultConstructor)
  ...
  }, {"./_a-function": 1, "./_an-object": 4, "./_wks": 80}],
...
// false -> String#codePointAt
    module.exports = function (TO_STRING) {
      return function (that, pos) {
        ...
        a = s.charCodeAt(i);
        return a < 0xd800 || a > 0xdbff || i + 1 === l || (b = s.charCodeAt(
            i + 1)) < 0xdc00 || b > 0xdfff
...
// B.2.3.2.1 CreateHTML(string, tag, attribute, value)
  ...
  }, {"./_defined": 14, "./_export": 19, "./_fails": 21}],
...
// and the second argument - flag - preferred type is a string
  ...
  77: [function (require, module, exports) {
    ...
    var px = Math.random();
    module.exports = function (key) {
      return 'Symbol('.concat(key === undefined ? '' : key, ')_',
          (++id + px).toString(36));
    };
  ...
  80: [function (require, module, exports) {
    ...
    var $exports = module.exports = function (name) {
      return store[name] || (store[name] =
          USE_SYMBOL && Symbol[name] || (USE_SYMBOL ? Symbol : uid)(
              'Symbol.' + name));
    };

    $exports.store = store;

  }, {"./_global": 25, "./_shared": 65, "./_uid": 77}],
  ...
  }, {"./_classof": 9, "./_core": 11, "./_iterators": 41, "./_wks": 80}],
      ...
      from: function from(arrayLike /* , mapfn = undefined, thisArg = undefined */) {
        ...
        if (iterFn != undefined && !(C == Array && isArrayIter(iterFn))) {
          for (iterator = iterFn.call(O), result = new C();
              !(step = iterator.next()).done; index++) {
            createProperty(result, index,
                mapping ? call(iterator, mapfn, [step.value, index], true)
                    : step.value);
          }
        } else {
...
// 22.1.3.30 Array.prototype[@@iterator]()
    module.exports = require('./_iter-define')(Array, 'Array',
...
// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
  ...
  }, {"./_object-gopd": 47, "./_object-sap": 55, "./_to-iobject": 73}],
...
// 19.1.2.14 Object.keys(O)
  ...
  }, {"./_object-keys": 53, "./_object-sap": 55, "./_to-object": 75}],
...
// 19.1.3.6 Object.prototype.toString()
  ...
  }, {"./_classof": 9, "./_redefine": 58, "./_wks": 80}],
...
// "new" creates a new object, old webkit buggy here
    ...
    if (require('./_descriptors') && (!CORRECT_NEW || require('./_fails')(
        function () {
      ...
      $RegExp = function RegExp(p, f) {
        ...
        return !tiRE && piRE && p.constructor === $RegExp && fiU ? p
            : inheritIfRequired(CORRECT_NEW
                    ...
                    : Base((piRE = p instanceof $RegExp) ? p.source : p,
        ...
        function (defined, MATCH, $match, maybeCallNative) {
          return [
            ...
            function match(regexp) {
              ...
              return fn !== undefined ? fn.call(regexp, O) : new RegExp(
                  regexp)[MATCH](String(O));
            },
            ...
            function (regexp) {
              ...
              while ((result = regExpExec(rx, S)) !== null) {
                ...
                A[n] = matchStr;
                if (matchStr === '') {
                  rx.lastIndex = advanceStringIndex(S,
        ...
        function (defined, REPLACE, $replace, maybeCallNative) {
          return [
            ...
            function replace(searchValue, replaceValue) {
              var O = defined(this);
              var fn = searchValue == undefined ? undefined
                  : searchValue[REPLACE];
              return fn !== undefined
          ...
          function getSubstitution(matched, str, position, captures,
                  ...
                  if (n > m) {
                    ...
                    if (f <= m) {
                      return captures[f - 1] === undefined
                          ? ch.charAt(1) : captures[f - 1] + ch.charAt(1);
                    }
                    return match;
                  }
        ...
        function (defined, SPLIT, $split, maybeCallNative) {
          ...
          if (
            ...
            internalSplit = function (separator, limit) {
              ...
              if (!isRegExp(separator)) {
                return $split.call(string, separator,
                    limit);
              }
              var output = [];
          ...
          return [
            ...
            function split(separator, limit) {
              var O = defined(this);
              var splitter = separator == undefined ? undefined
                  : separator[SPLIT];
...
// Don't use setters in Qt Script, https://github.com/zloirock/core-js/issues/173
    var setter = !QObject || !QObject[PROTOTYPE]
...
// fallback for old Android, https://code.google.com/p/v8/issues/detail?id=687
    ...
    var $propertyIsEnumerable = function propertyIsEnumerable(key) {
      ...
      if (this === ObjectProto && has(AllSymbols, key) && !has(OPSymbols,
          key)) {
        return false;
      }
    ...
    var $getOwnPropertyDescriptor = function getOwnPropertyDescriptor(it, key) {
      it = toIObject(it);
      key = toPrimitive(key, true);
      if (it === ObjectProto && has(AllSymbols, key) && !has(OPSymbols,
          key)) {
        return;
      }
      var D = gOPD(it, key);
      if (D && has(AllSymbols, key) && !(has(it, HIDDEN)
          && it[HIDDEN][key])) {
        D.enumerable = true;
      }
      return D;
    ...
    var $getOwnPropertyNames = function getOwnPropertyNames(it) {
      ...
      var key;
      while (names.length > i) {
        if (!has(AllSymbols, key = names[i++]) && key != HIDDEN && key
            != META) {
          result.push(key);
        }
      }
...
// 19.4.1.1 Symbol([description])
    if (!USE_NATIVE) {
      $Symbol = function Symbol() {
        ...
        var $set = function (value) {
          ...
          if (has(this, HIDDEN) && has(this[HIDDEN],
              tag)) {
    ...
    for (var wellKnownSymbols = $keys(wks.store), k = 0;
...
// https://github.com/tc39/proposal-object-getownpropertydescriptors
  ...
  103: [function (require, module, exports) {
    ...
    var Connector = /*#__PURE__*/function () {
      function Connector(options, WebSocket, Timer, handlers) {
        ...
        var path = this.options.path ? "".concat(this.options.path)
            : 'livereload';
        this._uri = "ws".concat(this.options.https ? 's' : '', "://").concat(
            this.options.host, ":").concat(this.options.port, "/").concat(path);
      ...
      _createClass(Connector, [{
        ...
        value: function _scheduleReconnection() {
          ...
          if (!this._reconnectTimer.running) {
            ...
            this._nextDelay = Math.min(this.options.maxdelay,
                this._nextDelay * 2);
          }
        }
      }, {
        ...
        value: function _onclose(e) {
          this.protocol = 0;
          this.handlers.disconnected(this._disconnectionReason,
              this._nextDelay);
  ...
  104: [function (require, module, exports) {
    ...
    var CustomEvents = {
      bind: function bind(element, eventName, handler) {
        ...
        throw new Error("Attempt to attach custom event ".concat(eventName,
      ...
      fire: function fire(element, eventName) {
        if (element.addEventListener) {
          ...
          throw new Error("Attempt to fire custom event ".concat(eventName,
  ...
  105: [function (require, module, exports) {
      ...
      _createClass(LessPlugin, [{
        ...
        value: function reloadLess(path) {
          ...
          var links = function () {
            ...
            for (var _i = 0,
                _Array$from = Array.from(document.getElementsByTagName('link'));
                _i < _Array$from.length; _i++) {
              link = _Array$from[_i];

              if (link.href && link.rel.match(/^stylesheet\/less$/i)
                  || link.rel.match(/stylesheet/i) && link.type.match(
                      /^text\/(x-)?less$/i)) {
                result.push(link);
              }
            }
          ...
          for (var _i2 = 0, _Array$from2 = Array.from(links);
    ...
    "core-js/modules/es6.array.from.js": 83,
    "core-js/modules/es6.array.iterator.js": 84,
    "core-js/modules/es6.object.to-string.js": 90,
    "core-js/modules/es6.regexp.match.js": 93,
    "core-js/modules/es6.string.iterator.js": 97,
  ...
  106: [function (require, module, exports) {
    ...
    var LiveReload = /*#__PURE__*/function () {
      function LiveReload(window) {
        ...
        && this.window.console.error ? this.window.location.href.match(
            /LR-verbose/) ? this.window.console : {
          log: function log() {
          },
        ...
        if (!(this.WebSocket = this.window.WebSocket
        ...
        this.connector = new Connector(this.options, this.WebSocket, Timer, {
          ...
          connected: function connected(protocol) {
            ...
            _this.log("LiveReload is connected to ".concat(_this.options.host,
                ":").concat(_this.options.port, " (protocol v").concat(protocol,
                ")."));
          ...
          disconnected: function disconnected(reason, nextDelay) {
            ...
            switch (reason) {
              case 'cannot-connect':
                return _this.log(
                    "LiveReload cannot connect to ".concat(_this.options.host,
                        ":").concat(_this.options.port,
                        ", will retry in ").concat(nextDelay, " sec."));

              case 'broken':
                return _this.log(
                    "LiveReload disconnected from ".concat(_this.options.host,
                        ":").concat(_this.options.port,
                        ", reconnecting in ").concat(nextDelay, " sec."));

              case 'handshake-timeout':
                return _this.log(
                    "LiveReload cannot connect to ".concat(_this.options.host,
                        ":").concat(_this.options.port,
                        " (handshake timeout), will retry in ").concat(
                        nextDelay, " sec."));
              ...
              case 'handshake-failed':
                return _this.log(
                    "LiveReload cannot connect to ".concat(_this.options.host,
                        ":").concat(_this.options.port,
                        " (handshake failed), will retry in ").concat(nextDelay,
                        " sec."));
              ...
              default:
                return _this.log(
                    "LiveReload disconnected from ".concat(_this.options.host,
                        ":").concat(_this.options.port, " (").concat(reason,
                        "), reconnecting in ").concat(nextDelay, " sec."));
            }
          },
          message: function message(_message) {
      ...
      _createClass(LiveReload, [{
        ...
        value: function performReload(message) {
          this.log("LiveReload received reload request: ".concat(
              JSON.stringify(message, null, 2)));
          return this.reloader.reload(message.path, {
            liveCSS: message.liveCSS != null ? message.liveCSS : true,
            liveImg: message.liveImg != null ? message.liveImg : true,
            reloadMissingCSS: message.reloadMissingCSS != null
                ? message.reloadMissingCSS : true,
            originalPath: message.originalPath || '',
            overrideURL: message.overrideURL || '',
            serverURL: "http://".concat(this.options.host, ":").concat(
                this.options.port),
        ...
        value: function shutDown() {
          ...
          return typeof this.listeners.shutdown === 'function'
              ? this.listeners.shutdown() : undefined;
        }
      }, {
        key: "hasPlugin",
        ...
        value: function analyze() {
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var pluginData = (typeof plugin.analyze === 'function'
                  ? plugin.analyze() : undefined) || {};
    ...
    "core-js/modules/es6.array.from.js": 83,
    "core-js/modules/es6.array.iterator.js": 84,
    "core-js/modules/es6.array.slice.js": 86,
    "core-js/modules/es6.function.name.js": 87,
    "core-js/modules/es6.object.keys.js": 89,
    "core-js/modules/es6.object.to-string.js": 90,
    "core-js/modules/es6.regexp.match.js": 93,
    "core-js/modules/es6.string.iterator.js": 97,
    "core-js/modules/es6.symbol.js": 99,
  ...
  107: [function (require, module, exports) {
    ...
    function _iterableToArrayLimit(arr, i) {
      var _i = arr && (typeof Symbol !== "undefined" && arr[Symbol.iterator]
          || arr["@@iterator"]);
      if (_i == null) {
        return;
      }
    ...
    Options.extract = function (document) {
      for (var _i = 0,
        ...
        if ((m = src.match(lrUrlRegexp)) && (mm = srcAttr.match(
            lrUrlRegexpAttr))) {
          var _m = m,
          ...
          options.host = host;
          options.port = port ? parseInt(port, 10) : portFromAttr ? parseInt(
              portFromAttr, 10) : options.port;
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                if ((keyAndValue = pair.split('=')).length > 1) {
                  options.set(keyAndValue[0].replace(/-/g, '_'),
    ...
    "core-js/modules/es6.object.to-string.js": 90,
    "core-js/modules/es6.regexp.match.js": 93,
    "core-js/modules/es6.regexp.replace.js": 94,
    "core-js/modules/es6.regexp.split.js": 95,
    "core-js/modules/es6.string.iterator.js": 97,
    "core-js/modules/es6.symbol.js": 99,
    "core-js/modules/web.dom.iterable.js": 102
  }],
  108: [function (require, module, exports) {
    ...
    var ProtocolError = function ProtocolError(reason, data) {
      ...
      this.message = "LiveReload protocol error (".concat(reason,
          ") after receiving data: \"").concat(data, "\".");
    };
      ...
      _createClass(Parser, [{
          ...
          try {
            ...
            if (this.protocol === 6) {
              ...
              return this.handlers.message({
                command: 'reload',
                path: options.path,
                liveCSS: options.apply_css_live != null ? options.apply_css_live
                    : true
              });
            }
        ...
        value: function _parseMessage(data, validCommands) {
          ...
          if (!validCommands.includes(message.command)) {
            throw new ProtocolError("invalid command '".concat(message.command,
                "', only valid commands are: ").concat(validCommands.join(', '),
                ")"), data);
          }
    ...
    "core-js/modules/es6.function.name.js": 87,
    "core-js/modules/es6.object.to-string.js": 90,
    "core-js/modules/es6.regexp.constructor.js": 91,
    "core-js/modules/es6.regexp.match.js": 93,
    "core-js/modules/es6.string.includes.js": 96,
    "core-js/modules/es6.string.iterator.js": 97,
    "core-js/modules/es6.symbol.js": 99,
  ...
  109: [function (require, module, exports) {
    ...
    function pickBestMatch(path, objects) {
      var pathFunc = arguments.length > 2 && arguments[2] !== undefined
      ...
      _createClass(Reloader, [{
        ...
        value: function reload(path) {
          var options = arguments.length > 1 && arguments[1] !== undefined
              ? arguments[1] : {};
          this.options = _objectSpread(_objectSpread({}, DEFAULT_OPTIONS),
              options); // avoid passing it through all the funcs
          ...
          for (var _i = 0, _Array$from = Array.from(this.plugins);
              _i < _Array$from.length; _i++) {
        ...
        value: function reloadImages(path) {
          ...
          for (var _i2 = 0, _Array$from2 = Array.from(this.document.images);
              _i2 < _Array$from2.length; _i2++) {
          ...
          if (this.document.querySelectorAll) {
            ...
            try {
              for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                ...
                for (var _i3 = 0, _Array$from3 = Array.from(
                    this.document.querySelectorAll(
                        "[style*=".concat(selector, "]")));
                    _i3 < _Array$from3.length; _i3++) {
          ...
          if (this.document.styleSheets) {
            return Array.from(this.document.styleSheets).map(
                function (styleSheet) {
                  return _this2.reloadStylesheetImages(styleSheet, path,
                      expando);
                });
          }
        }
        ...
        value: function reloadStylesheetImages(styleSheet, path, expando) {
          ...
          for (var _i4 = 0, _Array$from4 = Array.from(rules);
              _i4 < _Array$from4.length; _i4++) {
              ...
              case CSSRule.STYLE_RULE:
                ...
                try {
                  for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
                    ...
                    this.reloadStyleImages(rule.style, styleNames, path,
                        expando);
                  }
                } catch (err) {
                  _iterator3.e(err);
        ...
        value: function reloadStylesheet(path) {
          ...
          var links = function () {
            ...
            for (var _i5 = 0, _Array$from5 = Array.from(
                _this4.document.getElementsByTagName('link'));
                _i5 < _Array$from5.length; _i5++) {
          ...
          for (var _i6 = 0, _Array$from6 = Array.from(
              this.document.getElementsByTagName('style'));
              _i6 < _Array$from6.length; _i6++) {
          ...
          for (var _i7 = 0, _Array$from7 = Array.from(links);
              _i7 < _Array$from7.length; _i7++) {
            link = _Array$from7[_i7];
            this.collectImportedStylesheets(link, link.sheet, imported);
          } // handle prefixfree

          if (this.window.StyleFix && this.document.querySelectorAll) {
            for (var _i8 = 0, _Array$from8 = Array.from(
                this.document.querySelectorAll('style[data-href]'));
                _i8 < _Array$from8.length; _i8++) {
              style = _Array$from8[_i8];
              links.push(style);
            }
          }

          this.console.log("LiveReload found ".concat(links.length,
              " LINKed stylesheets, ").concat(imported.length,
              " @imported stylesheets"));
          var match = pickBestMatch(path, links.concat(imported),
              function (link) {
          ...
          if (match) {
            if (match.object.rule) {
              ...
              this.console.log("LiveReload is reloading stylesheet: ".concat(
            ...
            if (options.reloadMissingCSS) {
              ...
              for (var _i9 = 0, _Array$from9 = Array.from(links);
                  _i9 < _Array$from9.length; _i9++) {
                link = _Array$from9[_i9];
                this.reattachStylesheetLink(link);
              }
            } else {
              this.console.log("LiveReload will not reload path '".concat(path,
            ...
            for (var index = 0; index < rules.length; index++) {
              ...
              switch (rule.type) {
                ...
                case CSSRule.IMPORT_RULE:
                  ...
                  this.collectImportedStylesheets(link, rule.styleSheet,
                      result);
                  break;
        ...
        value: function waitUntilCssLoads(clone, func) {
          ...
          return this.Timer.start(options.stylesheetReloadTimeout,
              executeCallback);
        }
      }, {
        key: "linkHref",
        value: function linkHref(link) {
          ...
          return link.href || link.getAttribute && link.getAttribute(
              'data-href');
        }
      }, {
        ...
        value: function reattachStylesheetLink(link) {
          ...
          return this.waitUntilCssLoads(clone, function () {
            ...
            return _this6.Timer.start(additionalWaitingTime, function () {
              ...
              return _this6.window.StyleFix ? _this6.window.StyleFix.link(clone)
                  : undefined;
            });
          }); // prefixfree
        }
        ...
        value: function reattachImportedRule(_ref) {
          ...
          return this.Timer.start(this.importCacheWaitPeriod, function () {
            ...
            return _this7.Timer.start(_this7.importCacheWaitPeriod,
                function () {
                  // if another reattachImportedRule call is in progress, abandon this one
                  if (rule.__LiveReload_newHref !== href) {
                    return;
        ...
        value: function generateCacheBustUrl(url, expando) {
          ...
          if (options.overrideURL) {
            if (url.indexOf(options.serverURL) < 0) {
              var originalUrl = url;
              url = options.serverURL + options.overrideURL + '?url='
                  + encodeURIComponent(url);
              this.console.log(
                  "LiveReload is overriding source URL ".concat(originalUrl,
                      " with ").concat(url));
            }
          }

          var params = oldParams.replace(/(\?|&)livereload=(\d+)/,
              function (match, sep) {
    ...
    "core-js/modules/es6.array.filter.js": 82,
    "core-js/modules/es6.array.from.js": 83,
    "core-js/modules/es6.array.iterator.js": 84,
    "core-js/modules/es6.array.map.js": 85,
    "core-js/modules/es6.array.slice.js": 86,
    "core-js/modules/es6.function.name.js": 87,
    "core-js/modules/es6.object.get-own-property-descriptor.js": 88,
    "core-js/modules/es6.object.keys.js": 89,
    "core-js/modules/es6.object.to-string.js": 90,
    "core-js/modules/es6.regexp.constructor.js": 91,
    "core-js/modules/es6.regexp.match.js": 93,
    ...
    "core-js/modules/es6.regexp.split.js": 95,
    "core-js/modules/es6.string.iterator.js": 97,
    "core-js/modules/es6.string.link.js": 98,
    "core-js/modules/es6.symbol.js": 99,
  ...
  110: [function (require, module, exports) {
    ...
    var LiveReload = window.LiveReload = new (require(
        './livereload').LiveReload)(window);
